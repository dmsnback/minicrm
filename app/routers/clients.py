...
from app.users.manager import current_user, current_superuser
...
async def get_all_clients(
    ...
    if not clients:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail="Нет ниодного клиента")
    return clients
...
async def create_client(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail="Ошибка при добавлении клиента")
...
async def update_client(
    ...
    try:
        ...
        raise HTTPException(status.HTTP_500_INTERNAL_SERVER_ERROR, detail="Ошибка при изменении клиента")
...
async def delete_cliennt(
    ...
    try:
        ...
        raise HTTPException(status.HTTP_500_INTERNAL_SERVER_ERROR, detail="Ошибка при удалении клиента")
